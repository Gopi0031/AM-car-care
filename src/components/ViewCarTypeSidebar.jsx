...
export default function ViewCarTypeSidebar() {
  ...
  return (
    <>
      {/* Floating Button - Opens Brand Page Directly */}
      <button
        onClick={() => router.push('/car-brands')}
        className="fixed top-[7.5rem] xs:top-24 left-3 xs:left-4 sm:left-6 z-50 group touch-manipulation"
