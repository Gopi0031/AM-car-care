          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm font-light">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+91XXXXXXXXXX" className="hover:text-white transition-colors duration-300">
                  +91 XXX XXX XXXX
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@automotivecarcare.com" className="hover:text-white transition-colors duration-300">
