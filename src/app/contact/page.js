          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="order-1 lg:order-2">
              <div className="sticky top-8">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <a href="tel:+911234567890" className="text-white font-light text-lg hover:text-amber-400 transition-colors">
                          +91 12345 67890
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@automotivecarcare.com" className="text-white font-light text-lg hover:text-amber-400 transition-colors break-all">
                    ...
                    <div className="flex items-start group">
                      ...
                      <div>
                        ...
                        <p className="text-white font-light text-lg">Open 24/7</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* Map Placeholder */}
                <div className="bg-gray-100 h-64 flex items-center justify-center border-2 border-gray-200">
                  <div className="text-center">
                    <svg className="w-20 h-20 text-gray-300 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                    <p className="text-gray-400 font-light">Map Location</p>
                  </div>
                </div>
              </div>
            </div>
