                          ...
                          <tr>
                            <td style="padding: 25px 20px; margin-top: 25px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 8px;">
                              <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.7;">
                                ...
                                Call us at <a href="tel:${process.env.CONTACT_PHONE}" style="color: #856404; font-weight: 700; text-decoration: none;">${process.env.CONTACT_PHONE || '+91 12345 67890'}</a>
                              </p>
                            </td>
                          </tr>
                        </table>
                    ...
                    <tr>
                      <td style="background: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
                        ...
                        <p style="margin: 0; color: #636e72; font-size: 14px; line-height: 1.8;">
                          ...
                          📞 <span style="color: #2d3436; font-weight: 500;">${process.env.CONTACT_PHONE || '+91 12345 67890'}</span><br>
