                            ...
                            <td style="padding: 25px;">
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td style="padding: 10px 0; color: #2d3436; font-size: 15px; font-weight: 500;">${booking.serviceName || booking.service}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 10px 0; color: #636e72; font-size: 14px; font-weight: 600;">Price:</td>
                                  <td style="padding: 10px 0; color: #00b894; font-size: 18px; font-weight: 700;">₹${booking.servicePrice}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 10px 0; color: #636e72; font-size: 14px; font-weight: 600;">Vehicle:</td>
                                  <td style="padding: 10px 0; color: #2d3436; font-size: 15px; font-weight: 500;">${booking.vehicleType}</td>
                                </tr>
                                <tr>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background: #f8f9fa; border-radius: 12px; border: 1px solid #e9ecef; overflow: hidden;">
                          <tr>
                            <td style="padding: 25px;">
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  <td style="padding: 8px 0; color: #636e72; font-size: 14px; font-weight: 600; width: 30%;">Service:</td>
                                  <td style="padding: 8px 0; color: #2d3436; font-size: 15px; font-weight: 600;">${booking.serviceName}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 8px 0; color: #636e72; font-size: 14px; font-weight: 600;">Price:</td>
                                  <td style="padding: 8px 0; color: #00b894; font-size: 18px; font-weight: 700;">₹${booking.servicePrice}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 8px 0; color: #636e72; font-size: 14px; font-weight: 600;">Vehicle:</td>
                                  <td style="padding: 8px 0; color: #2d3436; font-size: 15px; font-weight: 500;">${booking.vehicleType}</td>
                                </tr>
                                <tr>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                          <tr>
                            <td style="padding-top: 30px; text-align: center;">
                              <a href="${'https://auto-car-care.vercel.app/'}/admin/dashboard" 
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="padding: 40px 30px;">
                            ...
                            <td style="padding: 30px;">
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                  ...
                                  <td style="padding: 12px 0; color: #2d3436; font-size: 16px; font-weight: 600;">${booking.serviceName || booking.service}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 12px 0; color: #636e72; font-size: 14px; font-weight: 600;">Price:</td>
                                  <td style="padding: 12px 0; color: #00b894; font-size: 22px; font-weight: 800;">₹${booking.servicePrice}</td>
                                </tr>
                                <tr>
                                  <td style="padding: 12px 0; color: #636e72; font-size: 14px; font-weight: 600;">Vehicle:</td>
                                  <td style="padding: 12px 0; color: #2d3436; font-size: 16px; font-weight: 500;">${booking.vehicleType}</td>
                                </tr>
                                <tr>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                          <tr>
                            <td style="padding: 25px 20px; margin-top: 20px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 8px;">
                              <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.7;">
                                <strong>💡 Pro Tip:</strong> Save this email for quick reference. If you have any questions or need to make changes, don't hesitate to reach out to our team!
                              </p>
                            </td>
                          </tr>
                        </table>
                    ...
                    <tr>
                      <td style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 35px 30px; text-align: center; border-top: 1px solid #dee2e6;">
                        ...
                        <p style="margin: 0; color: #636e72; font-size: 15px; line-height: 1.8;">
                          ...
                          📞 <a href="tel:${process.env.CONTACT_PHONE || '+91XXXXXXXXXX'}" style="color: #00b894; text-decoration: none; font-weight: 700;">${process.env.CONTACT_PHONE || '+91 XXXXX XXXXX'}</a>
                        </p>
